# 东方Underground
主要类型为包含躲避和射击元素的H5弹幕游戏。参考游戏《东方project》。多媒体课程设计。[东方Underground_视频Demo](https://github.com/xuzichang/TouhouUnderground/blob/master/%E4%B8%9C%E6%96%B9Underground_Demo.mp4)
...
场景二：小型敌人根据类型不同发射出不同的子弹类型。
	...
	小型敌人塑料袋的子弹类型是圆环。（见下图1.2.1）
	小型敌人易拉罐的子弹类型是自狙击，跟踪角色的位置。(见下图1.2.2)
	小型敌人饮料瓶的子弹类型是旋转的弧，放射速度快且密集。（见下图1.2.3）
